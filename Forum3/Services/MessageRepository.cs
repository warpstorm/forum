...
namespace Forum3.Services {
	public class MessageRepository {
		...
		/// </summary>
		private void ProcessMessageBodyUrls(ProcessedMessageInput processedMessageInput) {
			var displayBody = processedMessageInput.DisplayBody;
		...
		/// </summary>
		private void FindMentionedUsers(ProcessedMessageInput processedMessageInput) {
			...
			foreach (Match regexMatch in regexUsers.Matches(processedMessageInput.DisplayBody)) {
				...
				if (user != null) {
					if (user.Id != _httpContextAccessor.HttpContext.User.GetUserId())
		...
		/// </summary>
		private void PostProcessMessageInput(ProcessedMessageInput processedMessageInput) {
		...
		/// </summary>
		private string GetMessagePreview(string messageBody, int previewLength, bool multiline = false) {
			// strip out quotes
