...
namespace Forum3.Controllers {
	...
	/// Eventually this will be migrated and cleaned up under a ProfileService class.
	/// </summary>
	[Route("[controller]/[action]")]
	public class Profile : ForumController {
		const string AuthenicatorUriFormat = "otpauth://totp/{0}:{1}?secret={2}&issuer={0}&digits=6";

		UserManager<DataModels.ApplicationUser> _userManager { get; }
		SignInManager<DataModels.ApplicationUser> _signInManager { get; }
		IEmailSender _emailSender { get; }
		ILogger _logger { get; }
		UrlEncoder _urlEncoder { get; }
